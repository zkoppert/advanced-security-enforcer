...
<!-- omit in toc -->
# Contributing to Advanced-Security-Enforcer
...
Before you ask a question, it is best to search for existing [Issues](https://github.com/zkoppert/Advanced-Security-Enforcer/issues) that might help you. In case you have found a suitable issue and still need clarification, you can write your question in this issue.

If you then still feel the need to ask a question and need clarification, we recommend the following:

- Open an [Issue](https://github.com/zkoppert/Advanced-Security-Enforcer/issues/new).
...
- To see if other users have experienced (and potentially already solved) the same issue you are having, check if there is not already a bug report existing for your bug or error in the [bug tracker](https://github.com/zkoppert/Advanced-Security-Enforcer/issues).
...
- Open an [Issue](https://github.com/zkoppert/Advanced-Security-Enforcer/issues/new). (Since we can't be sure at this point whether it is a bug or not, we ask you not to talk about a bug yet and not to label the issue.)
...
- Perform a [search](https://github.com/zkoppert/Advanced-Security-Enforcer/issues) to see if the enhancement has already been suggested. If it has, add a comment to the existing issue instead of opening a new one.
...
Enhancement suggestions are tracked as [GitHub issues](https://github.com/zkoppert/Advanced-Security-Enforcer/issues).
